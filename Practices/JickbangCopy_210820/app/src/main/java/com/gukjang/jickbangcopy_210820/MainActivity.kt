...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val arr = arrayOf(arrayOf(R.drawable.ic_launcher_background, "8000", "마포구 서교동", "1", "망원/홍대역 풀옵셕 넓은 원룸"),
                            arrayOf(R.drawable.ic_launcher_background, "28500", "마포구 서교동", "3", "신혼부부의 보금자리 서교동 신축"),
        ...
        for(i in 0..4){
            roomList.add(RoomData(R.drawable.ic_launcher_background, costToString(arr[i][1] as String),
        ...
        //roomList.add(RoomData(R.drawable.ic_launcher_background, "25000", "서울시 동대문구", "3", "아주 좋아요"))
    ...
    fun floorToString(floor : String) : String {
        ...
        if(floorInt < 0) return ", ${floorInt*(-1)}층"
